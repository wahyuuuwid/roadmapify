      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-24 space-y-8">
          ...
          <p className="max-w-3xl mx-auto text-xl md:text-2xl text-gray-400 leading-relaxed font-light">
            Bangun jalur pembelajaran personal dengan AI dan kuasai keterampilan
            melalui roadmap yang terstruktur.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
            <button
              onClick={() => navigate(`/auth/register/?ref=${Math.random().toString(36).substring(2)}`)}
              className="group px-8 py-4 bg-linear-to-r from-purple-600 to-blue-600 rounded-full font-semibold text-lg hover:shadow-[0_0_40px_rgba(147,51,234,0.5)] transition-all duration-300 flex items-center justify-center gap-2"
            >
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Kami percaya bahwa pembelajaran berkualitas tidak boleh terbatas
              oleh latar belakang atau akses. Roadmapify hadir untuk membantu
              Anda belajar dengan arah yang jelas, terstruktur, dan sesuai
              tujuan—tanpa harus tersesat di tengah banyaknya informasi.
            </p>
            <p className="text-gray-400 text-lg leading-relaxed">
              Dengan pendekatan berbasis AI, kami merancang jalur belajar yang
              personal agar Anda bisa berkembang lebih cepat, lebih fokus, dan
              lebih percaya diri dalam mencapai tujuan karir Anda.
            </p>
            <div className="flex gap-8 pt-4"></div>
          </div>
            ...
            <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Algoritma canggih yang memahami gaya belajar dan kecepatan
                    Anda
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Roadmap yang disusun berdasarkan tujuan karir spesifik Anda
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Hemat waktu dengan jalur belajar yang teroptimasi dan
                    terarah
                  </p>
                </div>
              </div>
          ...
          {[
            ...
            <div key={idx} className="group relative">
              ...
              <div className="relative h-full bg-white/3 backdrop-blur-sm border border-white/8 rounded-2xl p-8 hover:border-white/20 transition-all duration-300 hover:-translate-y-1">
                <div
                  className={`inline-flex p-3 rounded-xl bg-linear-to-r ${feature.gradient} bg-opacity-10 mb-6`}
                >
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-purple-900/50 to-blue-900/50 border border-white/10 p-12 md:p-20 text-center">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-gray-300 text-lg">
              Bergabunglah dengan revolusi pembelajaran. Jadilah bagian dari
              generasi yang menguasai masa depan melalui teknologi dan
              pengetahuan yang terstruktur.
            </p>
            <button
              onClick={() => navigate(`/auth/login/?ref=${Math.random().toString(36).substring(2)}`)}
              className="mt-8 px-10 py-5 bg-white text-black rounded-full font-bold text-lg hover:scale-105 transition-transform duration-300 shadow-[0_0_40px_rgba(255,255,255,0.3)]"
            >
